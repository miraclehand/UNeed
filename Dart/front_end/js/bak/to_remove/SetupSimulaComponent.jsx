...
class SetupSimulaComponent extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSelectStdDisc(newStdDisc) {
        ...
        this.props.changeSimulaStdDisc(newStdDisc)
    }
    ...
    handleDeselectStdDisc(delStdDisc) {
        this.props.changeSimulaStdDisc('')
        this.onFocus()
    }
    ...
    render() {
        return (
            <>
                {this.props.simulaStdDisc &&
                    <View style={{ height:'6%' }} >
                        <FlatList
                            data = {[this.props.simulaStdDisc]}
                            horizontal
...
export default SetupSimulaComponent;
