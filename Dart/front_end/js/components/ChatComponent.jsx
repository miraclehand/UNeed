...
*/
    ...
    _generateArray() {
        const n = this.props.chats.length
        let arr = new Array(n);
        for (let i = n; i > 0; i--) {
            arr[n-i] = this.props.chats[i-1]
        }
        return arr;
        //return new Array(0);
    /*
        ...
        let arr = new Array(n);
        for (let i = n; i > 0; i--) {
            arr[n-i] = this.props.chats[0].messages[i-1]
        }
        return arr;
        */
    }
    ...
    _rowRenderer(type, chat) {
        //You can return any view here, CellContainer has no special significance
        return <BubbleComponent chat={chat} />
